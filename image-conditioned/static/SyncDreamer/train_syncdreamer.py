...
def get_parser(**parser_kwargs):
    ...
    # >>> [Release Cleanup MODIFIED BEGIN] Replace private absolute checkpoint
    # path with a repository-relative placeholder for public release.
    # Original SyncDreamer used a private absolute checkpoint path as the
    # default value.
    parser.add_argument("--finetune_from", type=str, default="ckpt/sd-image-conditioned-v2.ckpt", help="path to checkpoint to load model state from" )
