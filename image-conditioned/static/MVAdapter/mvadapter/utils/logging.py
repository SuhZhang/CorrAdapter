...
def get_verbosity() -> int:
    """
    Return the current level for the Hugging Face Diffusers root logger as an `int`.
...
def set_verbosity(verbosity: int) -> None:
    """
    Set the verbosity level for the Hugging Face Diffusers root logger.
...
def disable_default_handler() -> None:
    """Disable the default handler of the Hugging Face Diffusers root logger."""
...
def enable_default_handler() -> None:
    """Enable the default handler of the Hugging Face Diffusers root logger."""
...
def enable_explicit_format() -> None:
    """
    Enable explicit formatting for every Hugging Face Diffusers logger. The explicit formatter is as follows:
    ```
...
def reset_format() -> None:
    """
    Resets the formatting for Hugging Face Diffusers loggers.
